...
const ContactUsForm = () => {
  ...
  return (
    ...
    <div className=''>
        <form 
            className="flex flex-col gap-7 tablet:gap-5 phone:gap-3 "
            ...
            <div className='flex flex-col gap-2 tablet:gap-1'>
                ...
                <input  
                    ...
                    className="block p-[14px] tablet:p-[8px] phone:p-[6px] text-black outline-none border  border-[blue] rounded-md"
                ...
                />
                {
                        ...
                        <div className='flex flex-row gap-2'>
                            {/* dropdown */}
                                ...
                                <input
                                    ...
                                    className='w-[75%] block p-[14px]  tablet:p-[8px] phone:p-[6px] text-black outline-none border  border-[blue] rounded-md'
                                    {...register("phoneNo",  
                                    {
                    ...
                    <div className='flex flex-col gap-2 tablet:gap-1'>
                        ...
                        <textarea 
                            ...
                            id='message'
                            cols="30"
                            className='text-black tablet:h-20 phone:h-16 block p-[14px] tablet:p-[8px] phone:p-[6px] outline-none border  border-[blue] rounded-md'
                            rows="5"
                    ...
                    <button type='submit'
                        className='rounded-md  bg-black text-white text-center p-[11px]  tablet:p-[8px] phone:p-[6px] cursor-pointer font-bold'
                    >
                        Send Message
                    </button>

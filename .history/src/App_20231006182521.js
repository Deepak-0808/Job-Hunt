      ...
      <section>
        <nav id="navMain">
            <ul id="navBar">
              ...
              <div id="navCenter">
                <li id="home">
                <NavLink style={{textDecoration: 'none'}} className="navlinkColor" to="/">Home</NavLink>
                </li>
                <li>
                  <NavLink style={{textDecoration: 'none'}} className="navlinkColor" to="/Browse">Browsejob</NavLink>
                </li>
                <li>
                  <NavLink className="navlinkColor" to="/Candidates">Candidates</NavLink>
                </li>
              </div>
              <div id="navRightSide">
